ActiveAdmin.setup do |config|
  ...
  #
  # config.site_title_image = "/albert.png"
  ...
  #
  config.footer = 'Powered by caffeine, spreadsheets, and a tiny bit of financial wizardry. - Albert probably'
